"""Combined view for single run and comparison in one professional layout."""
...
class CombinedView(QtWidgets.QWidget):
    def __init__(self) -> None:
        ...
        splitter.addWidget(self._wrap_card(SingleRunView(), "Tek Deneme"))
    ...
    def _build_header(self) -> QtWidgets.QHBoxLayout:
        ...
        # Minimal header, no text to keep layout compact in fullscreen
        header.addStretch()
        return header
